        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-white/80 max-w-2xl mx-auto">
              Metodologia estruturada para gestão contábil e de pessoal eficiente
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              { step: "01", title: "Análise", desc: "Avaliação completa da situação contábil e trabalhista atual" },
              { step: "02", title: "Estruturação", desc: "Organização de processos e documentações necessárias" },
              { step: "03", title: "Implementação", desc: "Execução dos serviços contábeis e de departamento pessoal" },
              { step: "04", title: "Monitoramento", desc: "Acompanhamento contínuo e relatórios periódicos" }
            ].map((item) => (
